---
{"dg-publish":true,"permalink":"/y2-spring/csc2510/1-28-2026/1-4-predicates-quantifiers/","dg-note-properties":{}}
---
...
![activity-evaluating-quantified-statements.png](/img/user/Y2%20-%20Spring/zimages/1-28-2026/activity-evaluating-quantified-statements.png)
...
- a **logical expression** with more than one quantifier that bind **different variables in the same predicate**
	- example:
	- ![nested-quantifier-example.png\|489x150](/img/user/Y2%20-%20Spring/zimages/1-28-2026/nested-quantifier-example.png)
...
⬅ *back: [[Y2 - Spring/csc2510/1-21-2026/1-3-prop-equiv\|1-3-prop-equiv]]*
➡ *next: [[Y2 - Spring/csc2510/2-3-2026/1-6-8-rules-of-inference-proofs\|1-6-8-rules-of-inference-proofs]]*