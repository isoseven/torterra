---
{"dg-publish":true,"permalink":"/y2-spring/csc2510/2-3-2026/1-6-8-rules-of-inference-proofs/","dg-note-properties":{}}
---

# 👟 SUMMARY
- **proofs** are statements that form an argument.
- **rules of inference** are patterns of deductions (hypotheses to conclusions)
	- ![inference-rule.png\|169x86](/img/user/Y2%20-%20Spring/zimages/2-3-2026/inference-rule.png)
...
⬅ *back: [[Y2 - Spring/csc2510/1-28-2026/1-4-predicates-quantifiers\|1-4-predicates-quantifiers]]*
➡ *next: [[Y2 - Spring/csc2510/2-9-2026/2-1-2-sets-set-operations\|2-1-2-sets-set-operations]]*
