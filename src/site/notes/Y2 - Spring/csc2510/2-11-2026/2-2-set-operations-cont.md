---
{"dg-publish":true,"permalink":"/y2-spring/csc2510/2-11-2026/2-2-set-operations-cont/","dg-note-properties":{}}
---
...
- for sets $A$, $B$, the **difference/complement** of $A$ and $B$ ($A-B$) is the set of all elements in $A$ but not in $B$.
	...
	- ![set-chomp.png\|316](/img/user/Y2%20-%20Spring/zimages/set-chomp.png)
- the **complement** of a set is written as $\bar A$. it is $U-A$
	- the **universe of discourse** can be considered a set (call it $U$)
	- ![set-u.png\|315](/img/user/Y2%20-%20Spring/zimages/set-u.png)
...
- *ex.* Show $A \cap (B \cup C) = (A \cap B) \cup (A \cap C)$
	- ![set-example.png](/img/user/Y2%20-%20Spring/zimages/set-example.png)
...
⬅ *back: [[Y2 - Spring/csc2510/2-9-2026/2-1-2-sets-set-operations\|2-1-2-sets-set-operations]]*
➡ *next: [[Y2 - Spring/csc2510/2-16-2026/2-3-functions\|2-3-functions]]*